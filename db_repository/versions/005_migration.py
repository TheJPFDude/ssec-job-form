...
user = Table('user', pre_meta,
    ...
    Column('file', VARCHAR(length=120)),
)
...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['user'].columns['file'].drop()
    post_meta.tables['user'].columns['fileName'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['user'].columns['file'].create()
    post_meta.tables['user'].columns['fileName'].drop()
